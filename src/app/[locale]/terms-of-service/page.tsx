...
export default function TermsOfServicePage() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <p>By using this site, you agree not to misuse it, attempt unauthorized access, or present this fan wiki as an official taapr studios or Roblox property.</p>
    </LegalPage>
  );
}
